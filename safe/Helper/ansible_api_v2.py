...
from safe.data.DsRedisOps import DsRedis
...
class ANSRunner(object):
    ...
    def __initializeData(self):
        ...
        Options = namedtuple('Options', ['connection', 'module_path', 'forks', 'timeout', 'remote_user',
                                         ...
                                         'verbosity',
                                         'check', 'listhosts', 'listtasks', 'listtags', 'syntax', 'host_key_checking'])
        ...
        self.options = Options(connection='smart', module_path=None, forks=100, timeout=10,
                               ...
                               listtasks=False, listtags=False, syntax=False, host_key_checking=False)
...
def test():
    ...
    #                     }
    #                 }
    resource = [{'username': u'root', 'password': u'ybl8651073', 'hostname': u'192.168.56.101', "port": 22, }]
    rbt = ANSRunner(resource)
    print resource
    rbt.run_model(host_list=['192.168.56.101'], module_name='setup',module_args="")
